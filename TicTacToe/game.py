...
class TicTacToe:
    def __init__(self):
        self.board = [' ' for _ in range(9)] #t this will represent the board
    ...
    def print_board_nums():
        # 0 | 1 | 2 which number for what box
    ...
    def winner(self, square, letter):
        ...
        if square % 2 == 0:
            ...
            if all([spot == letter for spot in diagonal1]):
                return True
            diagonal2 =[self.board[i] for i in [2, 4, 6 ]]# righ to ledt diagonal
...
#makinfg the move
    ...
    if game.current_winner:
        ...
        # changing the letter after move
